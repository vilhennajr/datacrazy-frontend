...
const data = [
  {
    ...
    label: 'LinkedIn',
    url: 'https://www.linkedin.com/in/flaviano-vilhenna-jr-bb2866271/',
  },
  {
    icon: <DeviceHubTwoToneIcon />,
    label: 'Github',
    url: 'https://github.com/vilhennajr',
  },
  {
    icon: <SendTwoToneIcon />,
    label: 'Email',
    url: 'mailto:flavianovilhenna@gmail.com',
  },
]
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <ListItemText
              primary='Potencialize suas vendas com o CRM DataCrazy'
          ...
          >
            ...
            >
              <ListItemText
                ...
                secondary='E-mail, Github, LinkedIn'
